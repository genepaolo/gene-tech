...
import { PersonalIcon, LinkedinIcon, MoonIcon, SunIcon } from "../Icons";
  ...
  return (
    <header className="w-full p-4  px-5 sm:px-10 flex items-center justify-between">
        ...
        <div className=" hidden sm:flex items-center">
            <a href={siteMetadata.linkedin} className="inline-block w-6 h-6 mr-4" target="_blank" aria-label="LinkedIn"><LinkedinIcon className="hover:scale-125 transition-all ease duration-200" /></a>
            <a href={siteMetadata.personal} className="inline-block w-6 h-6 mr-4" target="_blank" aria-label="Personal Site"><PersonalIcon className="hover:scale-125 transition-all ease duration-200" /></a>
        </div>
    </header>
  )
}
